...
pub const DISCUSSIONS_URL: &str = "https://github.com/HakanSeven12/OpenCADStudio/discussions";

#[cfg(not(target_arch = "wasm32"))]
const FEED_URL: &str = "https://github.com/HakanSeven12/OpenCADStudio/discussions.atom";
...
fn parse_atom(feed: &str) -> Vec<DiscussionEntry> {
    feed.split("<entry>")
        ...
        .filter_map(|tail| {
            ...
            let url_start = entry
                .find("href=\"https://github.com/HakanSeven12/OpenCADStudio/discussions/")?
                + "href=\"".len();
...
fn pinned_numbers(page: &str) -> std::collections::HashSet<u64> {
    ...
    let Some(after_heading) = page
        .split_once("id=\"pinned-discussions\"")
        .map(|(_, rest)| rest)
    else {
        return numbers;
    };
